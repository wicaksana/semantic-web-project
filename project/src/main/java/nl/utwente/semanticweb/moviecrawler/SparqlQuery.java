...
//		Pattern p = Pattern.compile(".*" + mn + "_\\(film\\)$|.*" + mn + "_\\(\\d\\d\\d\\d_film\\)$", Pattern.CASE_INSENSITIVE); //ends with either "(film)" or "(????_film)"
		Pattern p = Pattern.compile(".*" + mn + "_\\(film\\)$|.*" + mn + "_\\(19(8|9)[0-9]_film\\)$|.*" + mn + "_\\(20(0|1)[0-9]_film\\)$*", Pattern.CASE_INSENSITIVE); //ends with either "(film)" or "(????_film)"
